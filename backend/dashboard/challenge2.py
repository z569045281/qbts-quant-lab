...
第一期($1000→+$100,本地 bot,2026-07 达标 +10.7%)的升级复刻:
  资金   $5000 · 地板已于 2026-07-21 取消 · 🏁 马拉松:跑到 2027-08-15
         (2026-07-10 用户改规则:不再 +10% 判赢收手 —— $5500 只是里程碑,
         落袋后继续滚;2026-08-18 用户「我没说停不许停」—— 原终点 8/15 到期
         自动 ENDED 于 $5,051.66,状态改回 running 并把终点延到 2027-08-15)
...
_END_DATE = "2027-08-15"   # 马拉松终点(2026-08-18 用户续跑:原 8/15 审判日已过)
