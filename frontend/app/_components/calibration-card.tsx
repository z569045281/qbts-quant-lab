    ...
    <section className="bg-surface rounded-inner border border-hairline overflow-hidden">
      ...
      <div className="px-5 py-4 grid grid-cols-1 lg:grid-cols-[200px_1fr] gap-5">
        ...
        <div className="space-y-2.5">
          <div>
            <div className="text-meta text-gray-500">累计预测</div>
            <div className="text-price font-bold text-gray-900 font-mono">{cal.n_total}</div>
            <div className="text-meta text-gray-400">{cal.n_graded} 条已可评判</div>
          </div>
          <div>
            <div className="text-meta text-gray-500">整体方向命中</div>
          ...
          {cal.n_total < 5 && (
            <div className="text-meta text-gray-400 italic leading-snug pt-2 border-t border-hairline">
        ...
        <div>
          <div className="text-meta text-gray-500 mb-2">
            各信号源（按样本量排序）
          </div>
          {bySorted.length === 0 ? (
            ...
            <div className="space-y-1">
              {bySorted.map(([src, info]) => (
                <div key={src} className="grid grid-cols-[1fr_60px_70px_70px] gap-2 text-body items-center">
                  ...
                  <span className="font-mono text-meta text-gray-500 text-right">
                    {info.hits}/{info.n}
                  </span>
          ...
          <p className="text-meta text-gray-400 mt-3 leading-snug">
